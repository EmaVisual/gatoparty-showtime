  ...
  return (
    <footer className="bg-gradient-to-t from-primary to-blue-900 dark:from-primary/20 dark:to-background text-white dark:text-foreground border-t border-border/50">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          href="#"
          className="flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-glow transition-all duration-300 animate-pulse"
